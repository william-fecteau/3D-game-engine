...
{
	private static final String VERTEX_FILE = "src/org/will/opengl/shaders/vertexShader.txt";
	private static final String FRAGMENT_FILE = "src/org/will/opengl/shaders/fragmentShader.txt";
